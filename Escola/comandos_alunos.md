...
CREATE DATABASE tecdev_escola_gabriela CHARACTER SET utf8mb4;
...
SELECT professores.no]~;me, cursos.titulo FROM professores INNER JOIN cursos ON professores.curso_id = cursos.id;
```
